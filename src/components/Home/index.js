...
const Home = () => {
  ...
  const getUserDetails = async () => {
    ...
    // api url
    const apiUrl = `https://apis2.ccbp.in/gpv/profile-details/${username}?api_key=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`
        ...
        <div>
          <div className="InputContainer">
            <input
              ...
              type="search"
            />
            <div className="search-icon-container" data-testid="searchButton">
              {/* <img
